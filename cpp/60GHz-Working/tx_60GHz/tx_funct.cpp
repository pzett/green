...
void tx_funct(int16_t output[]){
  ...
  int pre=10;
  int post=4;
  int nDataBin=6800; //35600;//71200
  int nPilotData=6*200;
  int nBits=4;
  int firstDone=0;
