...
///////////////////////////////////////// chosing the buffer size to exactly 1 second ////////////////////////////////////////////////////////////
    size_t buffer_size=rx_rate;//1000; // Select buffer size
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////// receiving IN a loop //////////////////////////////////////////////////////////////////////////////////////
    ...
    if(realTime == true)
      {
	//bool trainSeqFound = false; //this is used to exit the while loop when the comparing works
	int f = 0;
	while(f < (int) 5)//trainSeqFound == false )
	  {
        //receive buffer
	    stream_cmd.num_samps = buffer_size;
	    stream_cmd.stream_now = true;
		...
		num_rx_samps_latest_call= 
	      ...
	      //compare buffer
	      //std::cout << "comparing with training sequence!" << std::endl;
	...
	//plotting the buffer 
	// int c = 0; 
	// std::cout << "This is the buffer: " << std::endl;
	// while (c<(int) (buffer_size))//(2*total_num_samps)) 
	// 	{	  
	// 	  std::cout <<  buff_short[c] << ", ";
	// 	  c++;
	// 	};
	      //std::cout << "buffersize: " << c << ", ";
